        ...
        <div class="relative">
            @if(session('admin_nama'))
                <button id="profile-btn" class="flex items-center gap-3 bg-gray-100 px-3 py-2 rounded-xl hover:bg-gray-200 transition">
                    <img src="https://ui-avatars.com/api/?name={{ urlencode(session('admin_nama')) }}&background=667eea&color=fff"
                        class="w-8 h-8 rounded-full" alt="Avatar">
                    <span class="text-sm font-medium text-gray-700">{{ session('admin_nama') }}</span>
