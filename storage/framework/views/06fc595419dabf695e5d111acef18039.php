        ...
        <form method="GET" class="mb-4 flex items-center justify-between gap-3 flex-wrap">
            ...
            <div class="relative">
                <select name="entries" onchange="this.form.submit()" class="appearance-none border border-gray-300 rounded-xl bg-white text-sm px-4 py-2 pr-10
                    ...
                    <option value="5" <?php echo e(request('entries', $entries) == 5 ? 'selected' : ''); ?>>5</option>
                    <option value="10" <?php echo e(request('entries', $entries) == 10 ? 'selected' : ''); ?>>10</option>
                    <option value="25" <?php echo e(request('entries', $entries) == 25 ? 'selected' : ''); ?>>25</option>
                    <option value="50" <?php echo e(request('entries', $entries) == 50 ? 'selected' : ''); ?>>50</option>
                </select>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $teknisis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $teknisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-blue-50/50 transition duration-200 ease-in-out">
                                ...
                                <td class="px-6 py-4 font-medium text-gray-900">
                                    <?php echo e($teknisis->firstItem() + $index); ?>
