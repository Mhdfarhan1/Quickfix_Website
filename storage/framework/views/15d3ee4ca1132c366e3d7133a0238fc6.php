...
<body
    ...
    <div class="mb-6 flex flex-col items-center">
        <img src="<?php echo e(asset('assets/img/Logo_quickfix.png')); ?>" alt="Logo website"
    ...
    <div class="bg-white rounded-3xl shadow-2xl p-10 w-full max-w-md border border-blue-100">
        ...
        <form id="loginForm" action="<?php echo e(route('admin.login.submit')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\Quickfix_Website\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>